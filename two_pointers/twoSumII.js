...
const twoSumWithTwoPointers = (numbers, target) => {
    let left = 0;
...
TEST_CASES.forEach(({ numbers, target, result }) => console.log(result, twoSum(numbers, target)));
TEST_CASES.forEach(({ numbers, target, result }) => console.log(result, twoSumWithTwoPointers(numbers, target)));